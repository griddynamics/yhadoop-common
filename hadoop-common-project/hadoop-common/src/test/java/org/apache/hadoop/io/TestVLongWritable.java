...
public class TestVLongWritable extends TestCase {
  ...
  public void testSetGetVLong() {
    ...
    assertTrue("testSetGetVLong equals error !!!",
        new VLongWritable(545242l).equals(new VLongWritable(545242l)));
    assertTrue("testSetGetVLong compareTo error !!!",
        new VLongWritable(1l).compareTo(new VLongWritable(2l)) < 0);
    assertTrue("testSetGetVLong compareTo error !!!",
        new VLongWritable(2l).compareTo(new VLongWritable(1l)) > 0);
    assertTrue("testSetGetVLong compareTo error !!!",
        new VLongWritable(2l).compareTo(new VLongWritable(2l)) == 0);
  }
