...
public class TestGridMixClasses {
  ...
  public void test1() throws Exception {
    ...
    CompressionEmulationUtil.setCompressionEmulationEnabled(ctxt.getConfiguration(), true);
    
    Counter counter = new GenericCounter(TaskCounter.SPILLED_RECORDS.toString(),TaskCounter.SPILLED_RECORDS.toString(),33);
 ...
 //    mapper.cleanup(ctxt);
  ...
  private LoadSplit getLoadSplit() throws Exception{
    ...
    LoadSplit result = new LoadSplit(cfsplit, 2, 1, 4L, 5L, 6L, 7L, reduceBytes,
        reduceRecords, reduceOutputBytes, reduceOutputRecords, metrics,
        rMetrics);
    return result;
  }
  
  protected class FakeRecordReader extends RecordReader{
 ...
 private class  LoadRecordWriter extends RecordWriter {
